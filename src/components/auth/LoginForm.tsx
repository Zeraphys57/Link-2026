...
const DEMO_PESERTA = { email: 'devez@link2026.team', password: '1328513181', name: 'Dev C++ ez' }
...
export default function LoginForm() {
  ...
  const handleDemoLogin = async () => {
    setDemoLoading(true)
    const supabase = createClient()
    const { email, password, name } = DEMO_PESERTA
    ...
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-xl">
      ...
      <div className="mt-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 border border-gray-700 hover:border-amber-600 hover:text-amber-400 text-gray-300 text-sm font-medium py-2 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-3"
        >
          {demoLoading ? (
